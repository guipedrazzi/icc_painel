...
//AJAX DO CARROCEL, tem algum erro de lógica aqui, mas está funcionando então vamos manter kkk
function atualizaCarousel(data)
{
	var img = "";
	//console.log(data);
	if(data.length > 0)
...
function excluirArquivo(id_arq,nome_arq)
{
	...
	if(confirmar)
	{
		$.ajax({
			...
			type: 'post',
			data: {idarquivo: id_arq, id_imovel: id_imovel},
			success: function (data) {
				//console.log(data);
				data = JSON.parse(data);
				//console.log(data);
