		...
		<table  class="container" style="border: solid 1px; border-color: #c3c3c370">
			<tr>
				<td>
				    ...
				    <!-- ===== Banner ===== -->   
				    <div class="banner">
				        <p class="title-banner">Contato</p>
				    </div>

				    <p class="text-info">Lorem ipsum dolor sit amet, id quo eruditi eloquentiam. Elitr scripta ocurreret qui ad.</p>
					...
					<div class="txt-content">
						<table align="center" border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable">
							<tbody>
								<tr>
									<td><p>Nome Completo: &nbsp;<span class="text-dados">Teste</span></p></td>
								</tr>
								<tr>
									<td><p>E-Mail: &nbsp;<span class="text-dados">Teste</span></p></td>
								</tr>
								<tr>
									<td><p>Telefone: &nbsp;<span class="text-dados">Teste</span></p></td>
								</tr>						
								<tr>
									<td><p>Mensagem: &nbsp;<span class="text-dados">Teste</span></p></td>
								</tr>
							</tbody>
						</table>
					</div>
